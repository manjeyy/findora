...
@WebServlet(name = "reportLostItemServlet", value = "/report-lost-item")
public class ReportLostItemServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/pages/public/reportLostItem.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Create item
            Item item = new Item("lost", title.trim(), description.trim(), category,
                    locationId, eventDate, imageUrl, userId);
            ItemDAO.createItem(item);

            // Redirect to success page
            response.sendRedirect(request.getContextPath() + "/browse-items?type=lost");
