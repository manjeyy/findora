...
(
    ...
    moderation_status   ENUM ('clean', 'pending', 'flagged', 'spam')  NOT NULL DEFAULT 'pending',
    matched_item_id     INT,
...
ALTER TABLE Items
    MODIFY moderation_status ENUM('clean','pending','flagged','spam') NOT NULL DEFAULT 'pending';
