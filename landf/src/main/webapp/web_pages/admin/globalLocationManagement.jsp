...
<aside class="hidden md:flex flex-col h-screen w-64 fixed left-0 top-0 bg-slate-100 py-8 px-4 z-50">
    <div class="mb-10 px-2">
        <h1 class="text-lg font-bold text-teal-900 tracking-tight">Findora Admin</h1>
        <p class="text-slate-500 text-xs font-medium uppercase tracking-wider">Institutional Ledger</p>
    </div>
...
<main class="flex-1 md:ml-64 flex flex-col min-h-screen">
    ...
    <header class="bg-slate-50 sticky top-0 z-50 flex justify-between items-center px-6 py-3 w-full">
        <div class="flex items-center gap-4">
            <div class="relative">
<span class="absolute inset-y-0 left-3 flex items-center text-slate-400">
<span class="material-symbols-outlined text-lg" data-icon="search">search</span>
</span>
                <input class="bg-slate-100 border-none rounded-full py-2 pl-10 pr-4 text-sm focus:ring-2 focus:ring-primary w-64 md:w-80"
                       placeholder="Search locations..." type="text"/>
            </div>
        </div>
        <div class="flex items-center gap-4">
            <button class="p-2 text-teal-900 hover:bg-slate-200/50 transition-colors rounded-full">
                <span class="material-symbols-outlined" data-icon="notifications">notifications</span>
            </button>
            <img alt="User profile" class="w-9 h-9 rounded-full object-cover border-2 border-primary/20"
                 data-alt="Close-up portrait of a professional male administrator in a clean office setting, soft corporate lighting"
                 src="https://lh3.googleusercontent.com/aida-public/AB6AXuDmU-uUJC_5FJ9Zt2j78cNDoKDdYU9BkdBHkkfWGGkiB4z5GifU34i1s3vIjvgIUAoq6G2rtPWevCV8KcPK21HD7qaOmqDcidBgwf142s7Gk7Dha9AJWtrHbpyoEA8Ng0Ir0J3vhEqOiVIRTquyNoVPGKQQ3cug_wc0xHVZDIw8kdQ1Sk5jtP1LgvXs_t05hSq4YRo_iTksnZ2iacqVCEiy8bMFeT1JtH5rCsN6gxkGrFMYPSwSkXV5ZGqJU3eclYSFTC1L8XgInuU"/>
        </div>
    </header>
    <section class="p-8 lg:p-12 max-w-7xl w-full mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
                ...
                <h2 class="text-4xl md:text-5xl font-extrabold text-primary tracking-tight font-headline">Manage
                    Locations</h2>
                <p class="text-on-surface-variant mt-2 max-w-lg">Oversee the physical touchpoints of the institution's
                    lost and found network. Ensure accountability across all departments.</p>
            </div>
            <div class="flex gap-3">
                <button class="px-6 py-3 bg-primary text-white rounded-lg font-semibold flex items-center gap-2 hover:shadow-lg transition-all active:scale-95">
                    <span class="material-symbols-outlined" data-icon="add_location">add_location</span> New Location
                </button>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div class="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/15 flex items-center justify-between">
                <div>
                    <p class="text-label-sm text-on-surface-variant uppercase tracking-wider font-bold">Active
                        Custodians</p>
            ...
            <div class="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/15 flex items-center justify-between">
                <div>
                    <p class="text-label-sm text-on-surface-variant uppercase tracking-wider font-bold">Items in
                        Transit</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="group relative bg-surface-container-lowest rounded-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-primary/5 flex flex-col md:flex-row">
                <div class="w-full md:w-48 h-48 md:h-auto overflow-hidden">
                    <img alt="Main Library Exterior"
                         ...
                         data-alt="Wide shot of a modern glass and stone university library building at dusk with interior lights glowing warmly"
                         src="https://lh3.googleusercontent.com/aida-public/AB6AXuBXjir8dgN7Lr_U28l7LEiiqQ5x_NbPkO0dsR7mUmzMzSjyxyNZeJOj-Zh0ZKp-oh8teRJXp3BDQ33CZv9XSFBh2dI4R6xcQXtj8fJ5L9e1Pfw55k_X4Ajrq6adLSTUD7IaQgbVlascKniYz1VqGW-IwiAqrM8rQ8aP3VA9QKYfgIERdnEn_EdMEOEAvmEutUsDiNr24Wti-180w1HoAyFAgp08KcEwfUE_xIcBGaaLPD1u0BmnxmpU4HxI3fY5XJecMoFlq26IaUI"/>
                </div>
                <div class="p-6 flex-1 flex flex-col">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <div>
                            <p class="text-[10px] text-on-surface-variant uppercase tracking-widest font-bold">Managed
                                By</p>
                            <p class="text-sm font-semibold text-primary">Dr. Elena Vance</p>
                        </div>
                        <div>
                            <p class="text-[10px] text-on-surface-variant uppercase tracking-widest font-bold">Stored
                                Items</p>
                    ...
                    <div class="mt-auto pt-4 flex items-center justify-between gap-2 border-t border-surface-container-low">
                        <div class="flex gap-1">
                            <button class="p-2 hover:bg-surface-container-low rounded-lg text-primary transition-colors"
                                    title="Edit">
                            ...
                            <button class="p-2 hover:bg-error-container hover:text-error rounded-lg text-on-surface-variant transition-colors"
                                    title="Remove">
            ...
            <div class="group relative bg-surface-container-lowest rounded-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-primary/5 flex flex-col md:flex-row">
                <div class="w-full md:w-48 h-48 md:h-auto overflow-hidden">
                    <img alt="Student Sports Center"
                         class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
                         data-alt="Interior view of a high-ceilinged athletic center with blue gym floors and natural light streaming through high windows"
                         src="https://lh3.googleusercontent.com/aida-public/AB6AXuDCdDU_2rkMP8YrPXQ0KRums8j48p2xX43odnwBxvIgBUjFmtFL00xfNPrbaDRb8sa_vb1U2O1x3OMGaStM4cwHnyvvnocSli8oK8U_CuPHoAWYt4bBtuO78rg82fYy32EURyWYNIG0w9eiQjJ-oRE9wFQIScTUWVKm7DPr4t3y430-Wu0bMmz1KrhVKvmn3PxtoL5SXjbniJ8yksg_tF7tdSo68U78DEcxJFBpDzepysD7X9xz5_0lrTtnBoLhnyunVu-M8efemHo"/>
                </div>
                <div class="p-6 flex-1 flex flex-col">
                    <div class="flex justify-between items-start mb-4">
                        <div>
            ...
            <div class="group relative bg-surface-container-low rounded-xl overflow-hidden transition-all duration-300 flex flex-col md:flex-row opacity-80">
                <div class="w-full md:w-48 h-48 md:h-auto overflow-hidden grayscale">
                    <img alt="East Residence Hall" class="w-full h-full object-cover"
                         data-alt="Architecture shot of a modern brick residential dorm building with large windows under a clear sky"
                         src="https://lh3.googleusercontent.com/aida-public/AB6AXuDHlS4DBNFgNpCZCRRvVU7vYZvhoaSeHBlB_7p5M22_XJD38eGh0yN6GgXWthheibxBRLGcBv9XGAIxbHNWalYEjrvuqQJqvXp-PmWhwBN_xxCFtZVLfQb_sa-qXXb6m-_e0tx0t2fldbSeaboOjwSemMDax9VPOPin3r5UW9zGZENW7Pk5_owNEyqPRqRVfcf7cpMg7dOO8Gcm9HOneFPj0mX277zMP8Z6EoPJqBAqi90gmdYUVQdqX2g2TUWyotdaQE52vgAyHuk"/>
                </div>
                <div class="p-6 flex-1 flex flex-col">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                    ...
                    <div class="mt-auto pt-4 flex items-center justify-between gap-2 border-t border-surface-container-highest">
                        <div class="flex gap-1">
                            ...
                            <button class="p-2 hover:bg-primary-container hover:text-white rounded-lg text-secondary transition-colors"
                                    title="Reactivate">
    ...
    <footer class="bg-slate-50 w-full py-6 mt-auto border-t border-slate-200/10 flex flex-col md:flex-row justify-between items-center px-12">
        ...
        <p class="font-inter text-xs tracking-wide uppercase text-slate-400"> © 2024 Findora Lost &amp; Found. Managed
            Institutional Stewardship. </p>
...
<nav class="md:hidden fixed bottom-0 left-0 right-0 bg-slate-50 border-t border-slate-200/10 flex justify-around py-3 px-6 z-50">
