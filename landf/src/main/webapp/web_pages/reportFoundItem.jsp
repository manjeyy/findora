...
<!-- SideNavBar -->
<aside class="hidden md:flex h-screen w-64 fixed left-0 top-0 bg-slate-100 dark:bg-slate-950 flex-col py-8 px-4 z-50">
...
<a class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-500 dark:text-slate-400 hover:bg-white dark:hover:bg-slate-900 hover:text-teal-800 transition-all duration-300 ease-in-out font-manrope text-sm" href="#">
<span class="material-symbols-outlined">dashboard</span>
                Dashboard
            </a>
<a class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-teal-900 dark:text-teal-200 font-bold border-r-4 border-orange-500 bg-white dark:bg-slate-900 font-manrope text-sm" href="#">
...
<input class="w-full pl-10 pr-4 py-2 bg-surface-container-high rounded-full border-none focus:ring-2 focus:ring-primary/20 text-on-surface" placeholder="Search the ledger..." type="text"/>
</div>
</div>
<div class="flex items-center gap-4">
...
<img alt="User profile" class="w-full h-full object-cover" data-alt="professional headshot of a campus administrator with a friendly expression in a modern office setting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAOvsQm9ybo1ed7fXIy7pVYiz_eib9nYHOqtGj4wlI2lPNxsgKgeZeR3GwdvOqhdEK1HyWqbXd6013KrNHUNwDHoZrcfzv_yfbRNzXB3Y3olm3OMnu9qwBi8XUfVwl8Nq3_w4UxF8egjAznuz34dCkgcku7fx3VXAWgaxhodnFc-PUr0iUbJja8wWj944bOGae-3sv10Kl_FwZ5twOTD2cdYdFNfgnHyop6jhVJOC1I-_rbacSmcw_PhSf2k_nZavwtG9AvkquiJN4"/>
</div>
</div>
</header>
<!-- Page Content -->
...
<h2 class="text-4xl md:text-5xl font-extrabold font-headline text-primary mb-4 leading-tight">Found Item <br/>Submission Portal</h2>
...
<label class="block text-primary font-bold text-sm uppercase tracking-wider mb-4">Item Documentation</label>
...
<img alt="Item preview" class="absolute inset-0 w-full h-full object-cover opacity-0 group-hover:opacity-10 transition-opacity" data-alt="high quality product photography of a misplaced smartphone on a clean white surface with soft natural lighting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAzUineiNOZuZU6dA1zXxrf4TOc2wqLsPkL6A62jUNxLTBuExi0Wn_M8jYpYrpm9Brd6PDXxdZCoRbDIfGs_Sqt9PRtF2tV5LdAT0ftKaUFkSythK5N_FCDzjph3stcyvNjLVeRWdIFCeagdpHjaJtypYm4-FwO8IQ_3w93QTwahtv_F78SvUIWMQjTqYuMNPawMD7hCILE5khaskdamrbEKnHuCJQSKErakTHOigkrMnbTgtjhPY5RhF5T_fKKEbbSAyclR1fLw04"/>
</div>
</div>
...
<p class="text-sm leading-relaxed opacity-90">High-value items (wallets, electronics, jewelry) should be delivered directly to the Central Security Office after digital logging.</p>
</div>
<span class="material-symbols-outlined absolute -right-4 -bottom-4 text-9xl opacity-10" style="font-variation-settings: 'FILL' 1;">security</span>
</div>
</div>
...
<div class="relative">
<label class="block text-[0.65rem] font-bold text-outline uppercase mb-1 ml-1">Item Name</label>
<input class="w-full bg-surface-container-highest border-none rounded-lg px-4 py-3 text-on-surface focus:ring-2 focus:ring-primary/20 placeholder:text-outline/50" placeholder="e.g. Blue Hydroflask" type="text"/>
</div>
<div class="relative">
...
<!-- Description -->
<div>
<label class="block text-[0.65rem] font-bold text-outline uppercase mb-1 ml-1">Detailed Description</label>
<textarea class="w-full bg-surface-container-highest border-none rounded-lg px-4 py-3 text-on-surface focus:ring-2 focus:ring-primary/20 placeholder:text-outline/50" placeholder="Describe unique markings, scratches, or contents..." rows="4"></textarea>
</div>
<!-- Logistics -->
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
<div>
<label class="block text-[0.65rem] font-bold text-outline uppercase mb-1 ml-1">Date Found</label>
<div class="relative">
<input class="w-full bg-surface-container-highest border-none rounded-lg px-4 py-3 text-on-surface focus:ring-2 focus:ring-primary/20" type="date"/>
</div>
</div>
<div>
<label class="block text-[0.65rem] font-bold text-outline uppercase mb-1 ml-1">Found Location</label>
<div class="relative">
<input class="w-full bg-surface-container-highest border-none rounded-lg px-4 py-3 text-on-surface focus:ring-2 focus:ring-primary/20" placeholder="e.g. Library 2nd Floor" type="text"/>
</div>
</div>
</div>
<!-- Extra Notes -->
<div>
<label class="block text-[0.65rem] font-bold text-outline uppercase mb-1 ml-1">Extra Notes (Private)</label>
<input class="w-full bg-surface-container-highest border-none rounded-lg px-4 py-3 text-on-surface focus:ring-2 focus:ring-primary/20" placeholder="Internal staff comments..." type="text"/>
</div>
<div class="pt-6">
<button class="w-full bg-secondary-container text-on-secondary-container font-bold py-4 rounded-lg shadow-sm hover:shadow-md transition-all active:scale-[0.98] flex items-center justify-center gap-2" type="submit">
<span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">assignment_turned_in</span>
                                    Submit Found Item
                                </button>
<p class="text-center text-[0.6875rem] text-outline mt-4 font-medium uppercase tracking-widest">Formalizing entry into Findora Ledger v4.2</p>
</div>
</div>
</div>
</form>
...
<p class="text-on-surface-variant text-sm leading-relaxed">Pinpoint exactly where the item was found to help our pattern matching algorithm suggest potential owners who were in the same vicinity.</p>
</div>
<div class="w-full md:w-1/2 aspect-video rounded-xl overflow-hidden bg-surface-container-highest relative group">
<img alt="Map view" class="w-full h-full object-cover" data-alt="a clean, stylized digital map of a university campus showing buildings and pathways in a minimal architectural style" data-location="San Francisco" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDEu_LXe6BaaqdVGy8XZkgoSFr8k0BxHVndikv5V-XL7L2FvgZGJM_HQU2ECBuvujp4QXEkn97LHmPsZko7XmghdRgJYXJSyrgLnbOeqK25NtrCqqxBjQoZckjDXeeExb7i0ejNbaEzEQKu3BnLKrR6DdjoPq9xv8WzxUOzx0SavYn1BbClUYUcE7dGDUJDCn1zK3z86JWjZ5KLErs06OoY-Ml9dd7kEXi4JzsYE9HQFfT8z8q1PAo6NkmvWSOSC6vHmQpyraZc-ZU"/>
...
<nav class="md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-900 h-16 flex items-center justify-around px-4 z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
