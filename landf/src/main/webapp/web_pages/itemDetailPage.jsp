...
<span class="text-xl font-bold tracking-tighter text-teal-900 dark:text-teal-100 font-headline">Findora</span>
</div>
<nav class="hidden md:flex items-center gap-8">
<a class="text-slate-500 dark:text-slate-400 font-medium hover:text-teal-600 transition-colors duration-200 font-label" href="#">Dashboard</a>
<a class="text-slate-500 dark:text-slate-400 font-medium hover:text-teal-600 transition-colors duration-200 font-label" href="#">Analytics</a>
<a class="text-teal-800 dark:text-teal-300 font-bold border-b-2 border-teal-600 font-label" href="#">Directory</a>
</nav>
...
<img alt="User profile concierge" class="w-full h-full object-cover" data-alt="professional portrait of a concierge in a sharp uniform with friendly expression soft studio lighting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAyDFo3qieL-R2o2zfqURmW4koxklCHoLwDJ4LW-xmZGLmji0KWJA9l-eJlHhl3MVl-3980ulswEreTXrrXVnnPQa0O-wAhGpGgK00QO-pbrOypUebCg2dVK7c3KrbCMAkcj2Um59obgMxnCRhJ64sKlQIR7KHy--vM6dMtm3M1sQi5Qz0DKZnunf9iDnqasEV91p2Y0d27oBIClSnPGOMbOFNsUYG5mceOW2J1N0JaNOl8SHkKeGUCgypXk2k3_Z9p3g3IQayBLGo"/>
</div>
</div>
</header>
...
<img class="w-full h-full object-cover shadow-sm transition-transform duration-500 hover:scale-105" data-alt="Premium minimal designer watch with leather strap sitting on a clean stone surface with soft morning light" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDx07xUI9F097NeU-KT-5xd8Uw4BChvniJTvZhilRaZzRcP6GpgyGsgtcOSrhiIfWJxS6WWW6b00UKzGPvlLNcIJxxTJckhAk9ED_pSMEmEDGmKGESMM2vhuTg1ikZzo4VSnNoyXuwQVEdorvtmh7uATMdEjnGX6DA_v-yPdOcTkg1UFvm8P1lCZDUhg3E-nJs6-g5JDHgGso0xYBw4lYYL6gpMWu6l26PRcltf5su1sx5ENVAoDbMn87xod6IDAH9sIXZ9dfej22M"/>
</div>
<div class="grid grid-cols-3 gap-4">
<div class="aspect-square rounded-lg overflow-hidden bg-surface-container-low">
<img class="w-full h-full object-cover" data-alt="Close up detail of a watch dial with silver hour markers and luminous hands under soft lighting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuApIzZDcrHGd_07hxhXCycK_38bNJN76vkcZBMGYEZp9CfPry3yxBhAEhnN2y7zzGMKtm086OdmfX6WZUNSo6LYdsT8ujXXMzifG2pRiLvcMySmZuWflWDob1WldvZTvt8ePmk6lhynM6g0r6yUGvZohyopPxvY6OJTJ-Aox_9I-xkJfQBTUkTOmcoTsqJipS1YHUsmOhddkxyLcCGW8WhSiQXpLvvUXoBLqcK7GeiTfddAHcwO8XQY8m5igD5XzLfbWcovCDkvBdM"/>
</div>
<div class="aspect-square rounded-lg overflow-hidden bg-surface-container-low">
<img class="w-full h-full object-cover" data-alt="Side profile of a premium watch showing the crown and brushed metal finish on the case" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBz13qqlCj2G0Xz0V_pRZpFVaKNuH6QYvGvHfhDq6A34-fARv4bys74O2CmXqGoB5KiR2hoNZPThcpMqsNJ0VbV5qz1QdSiPf4pbNgvpkjxlpYgIGmrBq1Vf3U2DDH8jtlcPZuXtdVwx-m4E4jUWEjo2qz-IlfwBcVO3jjSvYYGLruSCIgtS7U2DcMIjvW1WjL0coEfmD3xAfshhZ9yZFcBm3IaoDXoxZiU33EWx3H8pdizJJTbj_vVAmzUKgaV6d8v4OiLuW-9Gyg"/>
</div>
<div class="relative aspect-square rounded-lg overflow-hidden bg-surface-container-low group cursor-pointer">
<img class="w-full h-full object-cover opacity-60" data-alt="Watch strap buckle detail showing fine leather grain and clean stitching" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAz4DWDMCZOjHdPExHx6qLyXk53H4eK1aNEf87wA0fCqvRGguZT1-TM7L8lg_uVZo7ZYqPCNEphCxK66uSuTGfT2adgsXy2AboLycOE7aw5GjilhXxfIljZuqaEiS8MMJu_6xColpmLq-NrfhYd3OZDExQC8Cs8XXMJmPr4k9LfjfnsFZem_w7xFCIv8uV3K-YXpw3qqyJfFaJ3YF9Y2PlLRdd9WpXOhn7Blc2HpcFg5fJWSHxqnL4Wb0jwZPwhxHP7IZtcMcs356I"/>
<div class="absolute inset-0 flex items-center justify-center font-headline font-bold text-on-surface">+2 More</div>
</div>
</div>
</div>
...
<h1 class="text-4xl md:text-5xl font-headline font-extrabold text-editorial text-on-surface">Silver Chronograph Watch</h1>
<p class="text-lg text-on-surface-variant leading-relaxed font-body">
                        Found near the South Terminal lounge area. The item appears to be a high-end stainless steel chronograph with a tan leather strap. No visible scratches on the sapphire crystal.
                    </p>
</div>
...
<div class="w-full">
<p class="text-xs font-bold text-on-surface-variant uppercase font-label mb-2">Location Found</p>
<div class="h-40 w-full rounded-lg bg-surface-variant overflow-hidden">
<img class="w-full h-full object-cover grayscale opacity-80 hover:grayscale-0 transition-all duration-300" data-alt="Minimal map preview showing a transit terminal area with teal colored markers and soft gray background" data-location="Heathrow Terminal 5" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBIGPpDOcEQDMiRUBTwM-ctouT-AJS6qaUw3RyCaX9CmjcwGEZ7I0zI6IFUaX67Y40qGfyf4FxsyDPgLgw1yhN0K8woi_XWpJfLvPpj1STO8VerfofJJ-C-Vif0MkQy-8wlIRn3QM4MVYLTuU-OfIJj3LeH3bZhxF72HQhhwwcxvpc69uosoxHzMMwUjD7vswdciuSlSzkGUuzjO2JjaWj7XfA6hxwE_Bu8XM5ZFhRebaH32emA4xXhxlCnnIMyaAYUWrH7osr6Ki4"/>
</div>
</div>
</div>
</div>
...
<button class="text-primary font-bold font-label flex items-center gap-2 hover:gap-3 transition-all">
...
<img class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" data-alt="Luxury watch in a presentation box with soft velvet lining and moody ambient lighting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCPmKGTOKCdPIPfziQ3qYZhVFhoXeAp5pkxQCNkJjmWtvv90wNJ_2SnFi-9yEVeotnUqVl9ATUPAT67pFsoKTOr-MnwnJeAIBLlA_fBVO6dlxxK_G5eUtctNElvxubtcAuZpg9KFmnaMYoInzVqvb42gyUC-aJ5AcQLGrzSIkL-ayJMDLy2a97YIPmitldHqi6wWOI__dqL3UYBYNmzGrx-ejhq5P_YJJ3BRxRVWw3E-9GXsYN_7Cg7d0Yjpj8vzN5a5SlpXYA31zI"/>
</div>
<div class="p-6">
...
<div class="group bg-surface-container-lowest rounded-lg overflow-hidden transition-all hover:shadow-[0_8px_24px_rgba(24,28,29,0.06)]">
<div class="aspect-square overflow-hidden">
<img class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" data-alt="Classic analog watch on a wooden table with soft focus morning light from a window" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCmNVnBWrot6JtE9_n1cQi-SlZV_u_A1Qn1kknePW0j-VCnbgTzdBytL9xsXrmMkxJLKQ4NDfK4zv01tscqHlLHGc_MOpP7BksrK2P5dz9ufsBbFXunO8UTaIqV6OqXw67KfehQyL6ssT2YMeZ2pqYt8L7-0_kZwmW2SKpK3tazMJ3RgXmwKy2TDIHetrnqWWlzecgJe4GLvnBFfNrtPSQkawjRgXWM5ANkQDXNyhpRSibbRFo3kb0EBLyUsr9iAbVOgXPqmAfKMZo"/>
</div>
<div class="p-6">
<div class="flex justify-between items-start mb-2">
...
<div class="group bg-surface-container-lowest rounded-lg overflow-hidden transition-all hover:shadow-[0_8px_24px_rgba(24,28,29,0.06)]">
<div class="aspect-square overflow-hidden">
<img class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" data-alt="Close up of a watch dial showing Roman numerals and blue hands on white face" src="https://lh3.googleusercontent.com/aida-public/AB6AXuABUcLaLz5K61r-VCV3bXEafewjNQo4XEOP8qBNdzVWASnljhVdHQUqrHZuXt34CsIo7CXDjWmg8GMVhniAaSaFuGNue49bhmjO34bC8LKS5KvC-658TST5BDXCS3h-oBigyFw-ZMw6xSy20YhwJvAxmP3wjw6b823YXm8-SfgBh2lmlqheIeq-TsZasqeW-8rMQ1jEyWG0oN-_6v2QmKpVOlRT5MXr1CjkNXlFcUcOM3ThoXK0GmOJyqfhHVspGZaZFbxFqfv1Ucc"/>
</div>
<div class="p-6">
<div class="flex justify-between items-start mb-2">
...
<p class="text-sm text-on-surface-variant font-body px-4">Refine your search or check related categories</p>
</div>
</div>
</div>
</section>
