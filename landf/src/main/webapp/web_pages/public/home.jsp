...
<main class="pt-28 pb-32 px-8 max-w-7xl mx-auto"> <!-- Hero Asymmetric Header -->
    <section class="mb-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
        <div class="lg:col-span-8"><h1 class="text-5xl font-extrabold headline-font text-on-surface mb-4" style="">
            Welcome back, Sushant. </h1>
            <p class="text-on-surface-variant text-lg max-w-2xl" style=""> Your morning overview of the community's lost
                treasures. 12 new matches found since your last check-in. </p></div>
        <div class="lg:col-span-4"> <!-- Gamification Widget -->
            <div class="bg-surface-container-lowest rounded-xl p-6 border-outline-variant/15 border flex items-center justify-between shadow-[0_8px_24px_rgba(24,28,29,0.04)]">
                <div><span class="text-xs font-bold text-on-surface-variant tracking-wider block mb-1" style="">CUSTODIAN RANK</span>
                    <div class="flex items-center gap-2"><span
                            class="text-3xl font-extrabold headline-font text-primary" style="">2,450</span> <span
                            class="text-xs font-semibold text-tertiary px-2 py-0.5 bg-tertiary-fixed rounded-full"
                            style="">LEVEL 12</span></div>
                </div>
                <div class="w-12 h-12 rounded-full bg-tertiary-fixed flex items-center justify-center"><span
                        class="material-symbols-outlined text-on-tertiary-fixed"
                        style="font-variation-settings: &quot;FILL&quot; 1">workspace_premium</span></div>
            </div>
        </div>
    ...
    <div class="flex flex-wrap gap-4 mb-16">
        <button class="flex items-center gap-2 bg-primary text-on-primary px-8 py-4 rounded-xl font-bold signature-gradient hover:scale-[0.98] transition-transform"
                style=""><span class="material-symbols-outlined" style="">add_circle</span> Report Found Item
        </button>
        <button class="flex items-center gap-2 bg-surface-container-lowest text-primary border border-primary/20 px-8 py-4 rounded-xl font-bold hover:bg-surface-container-low transition-colors"
                style=""><span class="material-symbols-outlined" style="">search_off</span> I Lost Something
        </button>
    </div> <!-- Bento Grid Layout -->
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8"> <!-- Suggested Matches (Priority Column) -->
        <div class="lg:col-span-4 space-y-6">
            <div class="flex justify-between items-end mb-2"><h2 class="text-xl font-bold headline-font" style="">
                Suggested Matches </h2> <a class="text-primary text-sm font-semibold hover:underline" href="#" style="">View
                All</a></div> <!-- Match Card -->
            <div class="bg-surface-container-lowest rounded-xl p-5 group cursor-pointer hover:shadow-[0_8px_24px_rgba(24,28,29,0.06)] transition-all">
                <div class="flex gap-4 items-center">
                    <div class="w-20 h-20 rounded-lg overflow-hidden bg-surface-container-high flex-shrink-0"><img
                            alt="White AirPods" class=""
                            ...
                            style=""/></div>
                    <div><span
                            class="text-[10px] font-bold text-secondary-container bg-secondary-fixed px-2 py-0.5 rounded-full mb-1 inline-block"
                            style="">92% MATCH</span>
                        <h3 class="font-bold text-on-surface" style="">AirPods Pro</h3>
                        <p class="text-xs text-on-surface-variant" style=""> Found in Central Park South </p></div>
                </div>
                <div class="mt-4 pt-4 border-t border-outline-variant/10 flex justify-between items-center"><span
                        class="text-xs font-medium text-on-surface-variant" style="">2 hours ago</span>
            ...
            <div class="bg-surface-container-lowest rounded-xl p-5 group cursor-pointer hover:shadow-[0_8px_24px_rgba(24,28,29,0.06)] transition-all">
                <div class="flex gap-4 items-center">
                    ...
                    <div><span
                        ...
                        <p class="text-xs text-on-surface-variant" style=""> Reported Lost at Subway L1 </p></div>
                </div>
                <div class="mt-4 pt-4 border-t border-outline-variant/10 flex justify-between items-center"><span
                        class="text-xs font-medium text-on-surface-variant" style="">5 hours ago</span>
                    <button class="text-primary font-bold text-sm" style=""> Verify Claim</button>
                </div>
            </div>
        </div> <!-- Recently Found Items (Main Grid) -->
        <div class="lg:col-span-8">
            <div class="flex justify-between items-end mb-8">
                <div><h2 class="text-2xl font-bold headline-font" style=""> Recently Found </h2>
                    <p class="text-sm text-on-surface-variant" style=""> New items cataloged in the last 24 hours </p>
                </div>
                <div class="flex gap-2">
                    <button class="p-2 rounded-full bg-surface-container-high text-on-surface-variant" style=""><span
                            class="material-symbols-outlined" style="">filter_list</span></button>
                    <button class="p-2 rounded-full bg-surface-container-high text-on-surface-variant" style=""><span
                            class="material-symbols-outlined" style="">grid_view</span></button>
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6"> <!-- Found Card 1 -->
                <div class="bg-surface-container-lowest rounded-xl overflow-hidden shadow-[0_8px_24px_rgba(24,28,29,0.03)] border-outline-variant/10 border">
                    <div class="h-48 relative overflow-hidden"><img alt="Black Umbrella"
                        ...
                        <div class="absolute top-4 left-4"><span
                                class="bg-primary-container text-on-primary text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest"
                                style="">Open</span></div>
                    </div>
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-2"><h3 class="font-bold text-lg headline-font"
                                                                               style=""> Designer Umbrella </h3> <span
                                class="material-symbols-outlined text-primary" style="">bookmark</span></div>
                        ...
                        <div class="flex items-center gap-3">
                            <div class="flex items-center gap-1 text-xs font-semibold text-on-surface-variant bg-surface-container-low px-3 py-1.5 rounded-lg"
                                 style=""><span class="material-symbols-outlined text-sm" style="">location_on</span>
                                Downtown Library
                            </div>
                            <div class="flex items-center gap-1 text-xs font-semibold text-on-surface-variant bg-surface-container-low px-3 py-1.5 rounded-lg"
                                 style=""><span class="material-symbols-outlined text-sm" style="">schedule</span> Just
                                Now
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-surface-container-lowest rounded-xl overflow-hidden shadow-[0_8px_24px_rgba(24,28,29,0.03)] border-outline-variant/10 border">
                    <div class="h-48 relative overflow-hidden"><img alt="Analog Watch"
                                                                    class="w-full h-full object-cover"
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex items-center gap-1 text-xs font-semibold text-on-surface-variant bg-surface-container-low px-3 py-1.5 rounded-lg"
                                 style=""><span class="material-symbols-outlined text-sm" style="">schedule</span> 3h
                                ago
                            </div>
                        </div>
                    </div>
    ...
    </div> <!-- Secondary Section: Recently Lost -->
    <section class="mt-20">
        <div class="flex justify-between items-end mb-8">
            <div><h2 class="text-2xl font-bold headline-font" style=""> Searching For... </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6"> <!-- Lost Item 1 -->
            <div class="bg-surface-container-low rounded-xl p-4 flex gap-4 items-center border border-outline-variant/15">
                <div class="w-16 h-16 rounded-lg overflow-hidden bg-surface-container-high"><img alt="Robot Keychain"
                                                                                                 ...
                                                                                                 style=""/></div>
                <div><h4 class="font-bold text-sm" style="">Blue Keychain</h4>
                    <p class="text-xs text-on-surface-variant" style=""> North District </p> <span
                            class="text-[10px] text-error font-bold mt-1 inline-block uppercase tracking-tighter"
                            style="">LOST</span></div>
            </div> <!-- Lost Item 2 -->
            <div class="bg-surface-container-low rounded-xl p-4 flex gap-4 items-center border border-outline-variant/15">
                <div class="w-16 h-16 rounded-lg overflow-hidden bg-surface-container-high"><img alt="Dog Collar"
                                                                                                 class="w-full h-full object-cover grayscale opacity-60"
                                                                                                 ...
                                                                                                 style=""/></div>
                <div><h4 class="font-bold text-sm" style="">Red Collar</h4>
                    <p class="text-xs text-on-surface-variant" style=""> Riverside Park </p> <span
                            class="text-[10px] text-error font-bold mt-1 inline-block uppercase tracking-tighter"
                            style="">LOST</span></div>
            </div> <!-- Lost Item 3 -->
            <div class="bg-surface-container-low rounded-xl p-4 flex gap-4 items-center border border-outline-variant/15">
                <div class="w-16 h-16 rounded-lg overflow-hidden bg-surface-container-high"><img alt="Polaroid Camera"
                                                                                                 class="w-full h-full object-cover grayscale opacity-60"
                                                                                                 ...
                                                                                                 style=""/></div>
                <div><h4 class="font-bold text-sm" style="">Instax Camera</h4>
                    <p class="text-xs text-on-surface-variant" style="">Arts Plaza</p> <span
                            class="text-[10px] text-error font-bold mt-1 inline-block uppercase tracking-tighter"
                            style="">LOST</span></div>
            </div> <!-- Lost Item 4 -->
            <div class="bg-surface-container-low rounded-xl p-4 flex gap-4 items-center border border-outline-variant/15">
                <div class="w-16 h-16 rounded-lg overflow-hidden bg-surface-container-high"><img alt="Silver Ring"
                                                                                                 class="w-full h-full object-cover grayscale opacity-60"
                                                                                                 ...
                                                                                                 style=""/></div>
                <div><h4 class="font-bold text-sm" style="">Silver Band</h4>
                    <p class="text-xs text-on-surface-variant" style=""> Main Street </p> <span
                            class="text-[10px] text-error font-bold mt-1 inline-block uppercase tracking-tighter"
                            style="">LOST</span></div>
            </div>
        </div>
    </section>
</main> <!-- BottomNavBar (Mobile Only) -->
<nav class="md:hidden fixed bottom-0 left-0 w-full flex justify-around items-center px-4 pb-6 pt-3 bg-white/80 backdrop-blur-xl z-50 rounded-t-3xl shadow-[0_-8px_24px_rgba(24,28,29,0.06)]">
    <a class="flex flex-col items-center justify-center bg-teal-50 text-teal-700 rounded-2xl px-5 py-2 tap-highlight-none active:scale-90 transition-transform"
       href="#" style=""> <span class="material-symbols-outlined" style="font-variation-settings: &quot;FILL&quot; 1">home</span>
        <span class="text-[11px] font-medium headline-font mt-1" style="">Home</span> </a> <a
        class="flex flex-col items-center justify-center text-slate-400 px-5 py-2 tap-highlight-none active:scale-90 transition-transform"
        href="#" style=""> <span class="material-symbols-outlined" style="">search</span> <span
        class="text-[11px] font-medium headline-font mt-1" style="">Search</span> </a> <a
        class="flex flex-col items-center justify-center text-slate-400 px-5 py-2 tap-highlight-none active:scale-90 transition-transform"
        href="#" style=""> <span class="material-symbols-outlined" style="">add_circle</span> <span
        class="text-[11px] font-medium headline-font mt-1" style="">Report</span> </a> <a
        class="flex flex-col items-center justify-center text-slate-400 px-5 py-2 tap-highlight-none active:scale-90 transition-transform"
        href="#" style=""> <span class="material-symbols-outlined" style="">person</span> <span
        class="text-[11px] font-medium headline-font mt-1" style="">Profile</span> </a></nav>
...
<div class="hidden md:block fixed bottom-10 right-10 z-40">
    <button class="w-16 h-16 bg-primary text-on-primary rounded-full flex items-center justify-center shadow-xl signature-gradient hover:scale-110 transition-transform"
            style=""><span class="material-symbols-outlined text-3xl" style="">add</span></button>
</div>
</body>
</html>
|