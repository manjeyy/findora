...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Manrope:wght@400;600;700;800&amp;family=Plus+Jakarta+Sans:wght@400;500;600;700&amp;display=swap"
          rel="stylesheet"/>
...
<nav class="fixed top-0 w-full z-50 bg-[#f7fafa]/80 backdrop-blur-md flex justify-between items-center px-8 h-20 max-w-full">
    <div class="text-xl font-bold tracking-tighter text-teal-900 ">The Curated Findora</div>
    <div class="hidden md:flex gap-8 items-center">
        ...
        <div class="w-10 h-10 rounded-full overflow-hidden border-2 border-primary-fixed">
            <img alt="User profile Findora"
                 data-alt="Close-up portrait of a professional concierge smiling warmly in a bright modern office setting"
                 src="https://lh3.googleusercontent.com/aida-public/AB6AXuCQj0WwiAj-2K6ClExEJ-FqJhsfBrCLXH3mYrODjqFdyu_8fwKPcwxWd8dW5N29j-kV2OIsI6MWzpJHMduT3tQkj1GaBHvLJmFksuicJpVROEuoaK1x9ia8880FA4boMVVHFJZjDHjrhIPTuxymTvg7M1YHKHXBOCArlBFYzZzRWGeKR--2qr_z064bwvGP0qT5Pe-Rj4gWQcQ8LzjyPKB92PXKphmeMFsjKOVa9h0_XvMQZPqA6UWlFfkPBHEXQp4A00QyuKk9lAw"/>
        </div>
    </div>
</nav>
        ...
        <div class="lg:col-span-2 glass-card rounded-xl p-8 bg-surface-container-lowest border border-outline-variant/15 flex flex-col justify-between">
            ...
            <div class="space-y-4">
                <div class="flex justify-between items-end">
                    ...
                    <p class="text-primary font-bold">1,550 <span
                            class="text-on-surface-variant font-normal">pts to go</span></p>
                </div>
        ...
        <div class="md:col-span-4 bg-surface-container-lowest rounded-xl p-6 border border-outline-variant/15">
            ...
            <div class="space-y-6">
                <div class="flex items-center gap-4 group">
                    ...
                    <img alt="Top User" class="w-10 h-10 rounded-full object-cover"
                         data-alt="Portrait of a young man with a friendly smile wearing outdoor gear in a sunny city square"
                         src="https://lh3.googleusercontent.com/aida-public/AB6AXuDK1tNG4XHXhTx5CbOqpmIIrGF2WFRKtlJGUqrCPCQoTnlk4b-JlmsdoW_pwrlYYV8csI2uMIysv_OSHamluDbVXUp2l38pNQrNz4ORZJuCnFrajVOhJqil4K1oJm-_A6tsl15Ki-7B_f4KidPDamZlDWJySbko5EPGguvuD6grmx0DdYmKlFXQOdXc0Tnmu5XEba3dkdw6pIgQOKMPwZeqrGAkMqSTzJ3v0lvNzFnI962viteaYYBrO3Fob7qMZU-fzC94je0_4bo"/>
                    <div class="flex-1">
                ...
                <div class="flex items-center gap-4 group bg-primary-fixed/20 p-2 -mx-2 rounded-lg">
                    ...
                    <img alt="User profile Findora" class="w-10 h-10 rounded-full object-cover"
                         data-alt="Portrait of a professional concierge smiling warmly in a bright modern office setting"
                         src="https://lh3.googleusercontent.com/aida-public/AB6AXuAvEm3LNE6EJXTLiB8vEUM3SQ51Hu1r-JUF-h_bUa1nvJvFapwr7OI58krMkpoNhS32l0SBaY3fuLRCb6MEqWxZTvRikTyWkNlNGJMHqFULNi33enjJwgj8blVaM-sLOBGYmU5gysfgGKy5SrPEtEw4oVhw1YO2cUO5G68PJXyveTh56baaC7GH5YzzuvRWnFxrL771Y4bLPHoAY3VMAerZA6acfIiAB4flIsZkLwWLT2zn4eG-5f8A8dgMRxYtUXuMqxbRvHyWMlI"/>
                    <div class="flex-1">
                ...
                <div class="flex items-center gap-4 group">
                    ...
                    <img alt="Rank 3 User" class="w-10 h-10 rounded-full object-cover"
                         data-alt="Portrait of a middle aged man with glasses and a kind expression in a bright library environment"
                         src="https://lh3.googleusercontent.com/aida-public/AB6AXuADclOaYf_NsfaICED_vaXvaYDvgFH31CUJJaBj6Vl5F_zNDU6wVFf7N0ZibsSqq_LOFVGpcN-QOktxTfLh0XK0amkIaOdNtWIDrzv-88ajX_hdSnV6o_3PluziA-W9mm6M16MkjCkcu2u5uZxlNNo0xQa-aYWsvFMbIJgG3JjqJYb5VENqH5rASbruo0lZgBsoQjoh1_MUATDl8HK4JSUJtOWrFVtHt-YafhnCFcl4xMVk8LSqXNPzhao0McCPQQjF4SjHz3AnLfo"/>
                    <div class="flex-1">
                ...
                <div class="flex items-center gap-4 group">
                    ...
                    <img alt="Rank 4 User" class="w-10 h-10 rounded-full object-cover"
                         data-alt="Portrait of a stylish young woman with headphones in a vibrant urban cafe setting"
                         src="https://lh3.googleusercontent.com/aida-public/AB6AXuBmLB8piukwz4tpI27sJg6_eTVnlc4Q9DrgatC4gFy1g2THbdJKHhQ09VU5iRCOE8JDQQc8zrLcsOaEn2HRRY4heoUrbyjhK2UXU8CJGQsKNy5xTeusV4pEgl8GwNJpMZMaZOmt0JAymh751R8kBsvKUjcPU3ZMID_E3ZKsTCT5zZXJi_835iNvHBektXJbhVNdEBtoirJg5ZAp5nsmRID8KNwPNQPUQCmRUHuoN-ek9amYrcoCW78p32KVElTPo6bAz8xTYQMXKNs"/>
                    <div class="flex-1">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="p-5 bg-surface-container-low rounded-xl border border-outline-variant/10 relative overflow-hidden group">
                        <div class="relative z-10">
                            ...
                            <p class="text-xs text-on-surface-variant mb-4">Report 3 found items in the next 48 hours to
                                complete.</p>
                    ...
                    <div class="p-5 bg-surface-container-low rounded-xl border border-outline-variant/10 group">
                        ...
                        <p class="text-xs text-on-surface-variant mb-4">Validate 5 pending item descriptions in your
                            local area.</p>
                        <div class="w-full bg-surface-variant h-1.5 rounded-full overflow-hidden">
...
<!-- BottomNavBar -->
<div class="md:hidden fixed bottom-0 left-0 w-full flex justify-around items-center px-4 pb-6 pt-3 bg-white/80 backdrop-blur-xl shadow-[0_-8px_24px_rgba(24,28,29,0.06)] z-50 rounded-t-3xl">
    ...
    <div class="flex flex-col items-center justify-center bg-teal-50 text-teal-700 rounded-2xl px-5 py-2">
