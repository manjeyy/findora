...
<main class="pt-24 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    <!-- Welcome Section -->
    <section class="mb-12">
        <h1 class="text-4xl sm:text-5xl font-extrabold text-on-surface mb-3">Welcome back</h1>
        <p class="text-on-surface-variant text-lg max-w-2xl">Your dashboard for finding lost and found items in your community</p>
    </section>

    <!-- Quick Actions Section -->
    <section class="mb-12">
        <h2 class="text-lg font-bold text-on-surface mb-4">Quick Actions</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <a href="${pageContext.request.contextPath}/report-found-item" class="flex flex-col items-start gap-3 bg-primary text-on-primary px-6 py-5 rounded-xl font-bold hover:shadow-lg transition-all hover:scale-[1.02]">
                <span class="material-symbols-outlined text-2xl">add_circle</span>
                <span>Report Found Item</span>
            </a>
            <a href="${pageContext.request.contextPath}/report-lost-item" class="flex flex-col items-start gap-3 bg-secondary text-on-secondary px-6 py-5 rounded-xl font-bold hover:shadow-lg transition-all hover:scale-[1.02]">
                <span class="material-symbols-outlined text-2xl">search</span>
                <span>Report Lost Item</span>
            </a>
            <a href="${pageContext.request.contextPath}/browse-items" class="flex flex-col items-start gap-3 bg-tertiary text-on-tertiary px-6 py-5 rounded-xl font-bold hover:shadow-lg transition-all hover:scale-[1.02]">
                <span class="material-symbols-outlined text-2xl">inventory_2</span>
                <span>Browse Items</span>
            </a>
            <a href="${pageContext.request.contextPath}/my-claims" class="flex flex-col items-start gap-3 bg-surface-container-high text-on-surface px-6 py-5 rounded-xl font-bold hover:bg-surface-container transition-all hover:scale-[1.02]">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-12">
        <div class="bg-white rounded-xl p-6 border border-outline-variant/10 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-on-surface-variant mb-2">Total Users</p>
        ...
        <div class="bg-white rounded-xl p-6 border border-outline-variant/10 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-on-surface-variant mb-2">Total Items</p>
                    <p class="text-3xl font-bold text-secondary">892</p>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 border border-outline-variant/10 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-on-surface-variant mb-2">Items Found</p>
                    <p class="text-3xl font-bold text-tertiary">245</p>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 border border-outline-variant/10 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-on-surface-variant mb-2">Items Claimed</p>
        ...
        <div class="bg-white rounded-xl p-6 border border-outline-variant/10 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-on-surface-variant mb-2">Pending Claims</p>
    ...
    <!-- Recent Activity -->
    <div class="bg-white rounded-xl border border-outline-variant/10 shadow-sm">
        <div class="p-6 border-b border-outline-variant/10">
            <h2 class="text-xl font-bold text-on-surface">Recent Activity</h2>
        </div>
        <div class="divide-y divide-outline-variant/10">
            <div class="p-6 flex items-center gap-4 hover:bg-surface-container-lowest transition-colors">
                <div class="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0">
                    <span class="material-symbols-outlined text-primary">add_circle</span>
                </div>
                <div class="flex-grow">
                    <p class="font-semibold text-on-surface">New item found</p>
                    <p class="text-sm text-on-surface-variant">Black leather wallet found at Central Park</p>
                </div>
                <span class="text-xs text-on-surface-variant whitespace-nowrap">2 hours ago</span>
            </div>
            <div class="p-6 flex items-center gap-4 hover:bg-surface-container-lowest transition-colors">
                ...
                <div class="flex-grow">
                    <p class="font-semibold text-on-surface">Item claimed successfully</p>
                    <p class="text-sm text-on-surface-variant">AirPods Pro - Claimed by Sarah Mitchell</p>
                </div>
                <span class="text-xs text-on-surface-variant whitespace-nowrap">5 hours ago</span>
            </div>
            <div class="p-6 flex items-center gap-4 hover:bg-surface-container-lowest transition-colors">
                ...
                <div class="flex-grow">
                    <p class="font-semibold text-on-surface">New claim pending verification</p>
                    <p class="text-sm text-on-surface-variant">Fossil Watch - Needs verification photos</p>
                </div>
                <span class="text-xs text-on-surface-variant whitespace-nowrap">1 day ago</span>
            </div>
        </div>
    </div>
</main>
