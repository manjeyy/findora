    ...
    <header class="rounded-2xl border border-slate-200 bg-white px-6 py-5">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div>
                ...
                <h1 class="mt-1 text-2xl font-bold">Reports & Moderation</h1>
            ...
            <table class="min-w-full divide-y divide-slate-200 text-sm">
                ...
                <tr class="align-top">
                    ...
                    <td class="px-3 py-3">
                        ...
                        <form method="post" action="<%= request.getContextPath() %>/admin/reports/review" class="space-y-2">
                ...
                <% if (reports.isEmpty()) { %>
                <tr>
                    <td colspan="4" class="px-3 py-8 text-center text-sm text-slate-500">No report records available.</td>
                </tr>
                <% } %>
                </tbody>
            </table>
