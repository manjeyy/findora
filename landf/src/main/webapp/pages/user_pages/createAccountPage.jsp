<html>
  ...
  <body
    class="bg-background font-body text-on-background min-h-screen flex flex-col"
  >
    ...
    >
      ...
      <div
        class="absolute top-[-10%] right-[-5%] w-96 h-96 rounded-full bg-primary-fixed opacity-20 blur-3xl"
      ></div>
      <div
        class="absolute bottom-[-10%] left-[-5%] w-80 h-80 rounded-full bg-secondary-fixed opacity-15 blur-3xl"
      ></div>
      <!-- Create Account Card -->
      <div class="w-full max-w-[480px] z-10">
        ...
        <div class="mb-10 text-left">
          <div class="flex items-center gap-3 mb-4">
            <div
              class="w-10 h-10 editorial-gradient rounded-lg flex items-center justify-center text-white"
            >
              <span
            ...
            <span
              class="font-headline text-2xl font-extrabold tracking-tight text-primary"
              >Findora</span
            >
          </div>
          <h1
            class="font-headline text-4xl font-extrabold text-on-surface mb-2 leading-tight"
          >
            Create your account
          </h1>
          <p class="text-on-surface-variant font-medium tracking-wide">
            Join the of lost property.
          </p>
        </div>
        <!-- Main Ledger Container -->
        <div
          class="bg-surface-container-lowest rounded-xl p-8 md:p-10 shadow-[0_24px_48px_-12px_rgba(24,28,29,0.06)] relative overflow-hidden"
        >
          <!-- Tonal accent line at top -->
          <div
            class="absolute top-0 left-0 w-full h-1 bg-secondary-container"
          ></div>
          <form class="space-y-6">
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                ...
                />
                <div
                  class="absolute inset-y-0 right-4 flex items-center text-outline-variant"
                >
                  <span
            ...
            <!-- Action Button -->
            <button
              class="w-full bg-secondary-container hover:bg-secondary text-on-secondary-container hover:text-white font-headline font-bold py-4 rounded-lg shadow-sm hover:shadow-lg hover:shadow-secondary/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
              type="submit"
            >
          ...
          <!-- Footer Navigation -->
          <div
            class="mt-10 pt-8 border-t border-outline-variant/10 text-center"
          >
            <p class="text-sm text-on-surface-variant">
              Already part of the ledger?
              <a
                class="text-primary font-bold ml-1 hover:underline decoration-2 underline-offset-4"
                href="#"
                >Back to Login</a
              >
            </p>
        ...
        <div class="mt-8 flex justify-between items-center px-2">
          <span
            class="text-[10px] font-bold text-outline uppercase tracking-[0.2em]"
          >
          </span>
